...
public class MailUtils {
    ...
    // 发件人邮箱地址
    private static final String emailAccount = "2393988929@qq.com"; // 这个是企业邮箱
    // 发件人邮箱授权码
    private static final String emailPassword = "rpiigmevmybeebai";
...
//        if (emails == null || emails.isEmpty()) return false;
        try {
            ...
            message.setFrom(new InternetAddress(emailAccount, "博客系统", "UTF-8"));
