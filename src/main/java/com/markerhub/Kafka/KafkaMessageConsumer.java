...
import com.markerhub.util.MailUtils;
        ...
        try {
            while (true) {
                ...
                for (ConsumerRecord<String,String> record: records) {
                    ...
                    log.info("send to "+record.key()+"————"+record.value());
...
//                    message.setFrom("3551865260@qq.com");
//                    message.setTo(record.value());
//                    message.setText("用户"+record.key()+"于"+formatted+"登陆");
                    mailUtils.sendEmail(record.value(),"登陆通知","用户"+record.key()+"于"+formatted+"登陆");
