 ...
 */
public class RpcServerHandler1 extends ChannelOutboundHandlerAdapter {
    ...
    public void write(ChannelHandlerContext ctx, Object msg, ChannelPromise promise) throws Exception {
        // 可以选择性处理某些类型
        System.out.println("RpcServerHandler1 channelRead0" + LocalDateTime.now().format(formatter));
        System.out.println("RpcServerHandler1 channelRead0  --over" + LocalDateTime.now().format(formatter));
        // 继续传递
