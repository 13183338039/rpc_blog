...
CREATE TABLE `m_user` (
  ...
  `permission` varchar(64) DEFAULT NULL COMMENT '角色/权限标识，供 Shiro 校验',
  PRIMARY KEY (`id`),
...
-- Records of m_user
-- ----------------------------
INSERT INTO `m_user` VALUES ('1', 'markerhub', 'https://image-1300566513.cos.ap-guangzhou.myqcloud.com/upload/images/5a9f48118166308daba8b6da7e466aab.jpg', null, '96e79218965eb72c92a549dd5a330112', '0', '2020-04-20 10:44:01', null, null);
